...
const Navbar = () => {
  ...
  return (
    <div className="custom-container">
      ...
      <div
        className={`w-[250px] md:hidden fixed top-0 right-0 h-full bg-white z-50 transform ${
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-full border-t border-gray-300 text-center text-[9px] py-3 text-[#4444]">
          ...
          <div className="flex justify-center text-center align-center gap-2">
            <div>
            ...
            <div className="flex gap-2">
              <div>
                <div className="text-[#996833] border border-[#996833] rounded-full w-[14px] h-[14px] text-center flex justify-center pt-0.5">
                  <a href="">
                    <FaInstagram />
                  </a>
                </div>

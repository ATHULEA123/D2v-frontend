...
import { designapproval, falseceilingcal, kitchenshape, Logo, wallpainting, wallpanel } from "../../assets/constant";
...
const LiveEstimation = () => {
  ...
  return (
    <div className="w-full custom-container">
      ...
      <button
        className={`bg-[#996830] text-white rounded-xl px-7 py-4 flex items-center justify-center font-semibold text-base leading-4 
          ${isMenuOpen ? "absolute top-[4.5rem] right-4" : "hidden lg:flex"}
        `}
      >
        Login <span className="ml-2"><FiArrowUpRight /></span>
      </button>
    </div>
    <div>
  ...
  <footer className="mt-20">
    ...
    <div className="flex justify-between items-center py-4">
      <p className="text-gray-500">
        ...
        <span className="text-black">Landify</span>
      </p>
